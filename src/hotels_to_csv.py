...
def hotels_to_csv(hotels):
    data = {
        ...
        'tripadvisor_clasification': [hotel.tripadvisor_clasification for hotel in hotels],
        ...
        'language_bulgarian': [hotel.language_bulgarian for hotel in hotels],
        'language_russian': [hotel.language_russian for hotel in hotels],
        'language_portuguese': [hotel.language_portuguese for hotel in hotels],
